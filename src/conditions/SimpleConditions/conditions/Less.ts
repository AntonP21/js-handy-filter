...
/**
 * The class for the condition "less than".
 */
export default class Less extends SimpleCondition {
  /**
  ...
  protected validate(value: SimpleValue): boolean {
    if (isNull(value) || isNull(this.value)) {
      throw new TypeError('Null cannot be checked by condition "less than"');
    }

    if (isUndefined(value) || isUndefined(this.value)) {
      throw new TypeError('Type "undefined" cannot be checked by condition "less than"');
    }
